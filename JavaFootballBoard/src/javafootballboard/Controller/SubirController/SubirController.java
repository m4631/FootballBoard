...
import javafootballboard.Controller.EquiposController.ComprobarCampos;
...
public class SubirController {
    ...
    public void asignarListeners(){
        ...
        subir.getJPuntajeA().addKeyListener(new onlyDigitsListener(subir.getJPuntajeA(), 3));
        subir.getJPuntajeB().addKeyListener(new onlyDigitsListener(subir.getJPuntajeB(), 3));
